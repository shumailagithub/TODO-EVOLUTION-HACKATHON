...
# Create SQLAlchemy engine with settings that work for both PostgreSQL and SQLite
import os
if DATABASE_URL.startswith("sqlite"):
    ...
    engine = create_engine(
        ...
        connect_args={
            "check_same_thread": False,  # Required for SQLite thread access
        }
    )
else:
    # PostgreSQL/NeonDB-specific settings
    engine = create_engine(
        DATABASE_URL,
